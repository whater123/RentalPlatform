...
import com.rent.pojo.redisPojo.GoodsPoint;
...
public class GoodsServiceImpl implements GoodsService {
    ...
    public List<EnterpriseGoods> getRedisBaseRecommendations(List<EnterpriseGoods> list) {
        ...
        //添加到返回列表
        enterpriseGoods.add(getGoodsById(goodsList1.get(n2).getGoodsId()));
    ...
    private EnterpriseGoods getGoodsById(int goodsId){
